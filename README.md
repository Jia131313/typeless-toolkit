...
6. **跨设备同步**(可选):点「账号同步」，选择坚果云或其他 WebDAV，填写应用密码和一条各设备相同的同步密码。
...
- `TypelessToolkit-v1.6.2-win-x64-portable.zip`：内置经过 SHA256 校验的 Node.js 24.15.0
- `TypelessToolkit-v1.6.2-win-x64-lite.zip`：使用系统 Node.js 22.12+
...
| 账号跨设备同步 | 管理器 | 通过坚果云或通用 WebDAV 同步 AES-256-GCM 加密的 refresh token；远端账号可在本机一键启用 |
